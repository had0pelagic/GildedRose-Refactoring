    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            IList<IItemActions> Items = new List<IItemActions> {
                ...
                new BlueItem ("Backstage passes to a TAFKAL80ETC concert", 15, 20),
                new BlueItem ("Backstage passes to a TAFKAL80ETC concert", 10, 49),
                new BlueItem ("Backstage passes to a TAFKAL80ETC concert", 5, 49),
